...
public class IntegerExpression extends ExpressionUnaire {
	...
	public IntegerExpression(ElementProgramme elementProgrammeParent, Integer valeur) {
		super();
		this.valeur = valeur;
	}
	...
	public ExpressionUnaire verifierAdditionAvec(ExpressionUnaire expressionUnaire) throws OperationImpossible {
		return expressionUnaire.verifierAdditionAvecInteger(this);
	}
	...
	public ExpressionUnaire verifierAdditionAvecInteger(IntegerExpression integerExpression) {
		IntegerExpression resultat = new IntegerExpression(null, integerExpression.getValeur() + this.getValeur());
		return resultat;
	}

	@Override
	public ExpressionUnaire verifierAdditionAvecInteger(DoubleExpression doubleExpression) {
	...
	public ExpressionUnaire verifierMultiplicationAvec(ExpressionUnaire expressionUnaire) throws OperationImpossible {
		return expressionUnaire.verifierMultiplicationAvecInteger(this);
	}
	...
	public ExpressionUnaire verifierMultiplicationAvecInteger(IntegerExpression integerExpression) {
		IntegerExpression resultat = new IntegerExpression();
	...
	public ExpressionUnaire verifierInferieurAvec(ExpressionUnaire expressionUnaire) throws OperationImpossible {
		return expressionUnaire.verifierInferieurAvecInteger(this);
	}
